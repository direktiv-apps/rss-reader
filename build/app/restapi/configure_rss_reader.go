...
//go:generate swagger generate server --target ../../app --name RssReader --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/rss-reader/build/templates --principal interface{}

func configureFlags(api *operations.RssReaderAPI) {
...
func configureAPI(api *operations.RssReaderAPI) http.Handler {
